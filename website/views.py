...
def main_page(request, pk = Cinema.objects.first(), pk2=datetime.date.today().strftime('%Y-%m-%d'), pk3='ALL', pk4 = 1):
    ...
    context = {'cinemas':cinemas, 'projections':projections,"Date":Date, "pk":pk, 'pk2':pk2, 'pk3':pk3, 'pk4':pk4, 'pages':pages}
